...
date: "Deadline: 24 January, 23:59"
output: pdf_document
---
...
### Problem 3
a. Look at histograms of two samples:

```{r, echo=FALSE, fig.height=3}
set.seed(1234)
sample1 <- rnorm(100, 4, 7)
sample2 <- rnorm(100, 11, 2)
hist(sample1, col="lightblue", xlim=c(-30, 30))
```

```{r, echo=FALSE, fig.height=3}
hist(sample2, col="lightgreen", xlim=c(-30, 30))
```
...
Look at the histogram below and answer the questions.

```{r, echo=FALSE}
set.seed(2)
w <- rbeta(1000, 2, 7)*100
hist(w, breaks=60, col= "deepskyblue", ylim=c(0, 40))
```

a. Is it true that the $50$% of values in `w` exceed $35$? Explain your answer.

b. Is it true that most values in `w` do not exceed $10$? Explain your answer.

c. Which of the following values is closer to be the median of `w`: $10$, $20$, $30$, $40$? Explain your answer.
