...
Link to the dataset: [http://math-info.hse.ru/f/2018-19/ling-data/icelandic.csv](http://math-info.hse.ru/f/2018-19/ling-data/icelandic.csv).
...
Choose two subsamples, aspirated and non-aspirated.
...
More interesting - let us create boxplot by all groups, see the field `cons1`.
