...
Now let's try to generate a population of ones and zeroes (recall our previous classes) and find the proportion of ones in it. Then take 1000 samples of size 100, calculate confidence intervals for proportion of ones in each sample and count how many intervals contain a population proportion.
