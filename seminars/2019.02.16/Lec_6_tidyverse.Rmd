...
How many dimonds in the `diamonds` dataset have `depth` greater than 65 and price greater or equal than 15 000?
...
#### Task 3
How many diamonds with `Fair` and `Good` cut and color `G`?
...
Calculate the mean value and standard deviation for each color. In the form fill the values for color with lowest mean value
```{r, include=FALSE}
diamonds %>% 
  group_by(color) %>% 
